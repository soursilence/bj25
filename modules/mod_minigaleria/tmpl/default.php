...
{ ?>
			   ...
			   <img src="<?php echo '/images/joomgallery/thumbnails/'.$v['path'].'/'.$v['img']; ?>" alt="<?php echo $v['imgtitle']; ?>" title="<?php echo $v['tit']; ?>" width="194" height="128" border="0" class="img-center" /></a>
