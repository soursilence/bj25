...
// $Id: changelog.php 4419 2014-11-29 20:06:27Z chraneco $
/******************************************************************************\
**   JoomGallery 2                                                            **
...
20141026
^ Links to Transifex languages removed because they don't work anymore

20140706
# JavaScript errors if language strings contained inverted commas

20140608
^ new JAVA-Applet 5.1.1

20140505
# Wrong calculation and display of the number of categories created by an owner
  in the user categories view
...
20140201
# Small typo leading to wrong display of category path in user panel

20131122
# Interface configuration parameters 'hidebackend' and 'showcatlink' not always
  working correctly

20131103
# Error with PHP 5.4 and 5.5 when FTP layer is enabled

20130827
# Syntax error in database query when creating zip archives of favourites

20130818
# Wrong variable used in JoomGallery router
