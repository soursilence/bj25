...
<div id="options">
  ...
  <div id="main-publish"><!-- start MAIN section -->
        <div id="publish"><!-- start TOPNEWS section -->

            <div class="top-clean"><!-- start TOP class -->
            </div><!-- end TOP class -->
...
<div class="modifydate" style="margin-left: 15px; float: left;">
		<?php echo JText::sprintf('LAST_UPDATED2', JHTML::_('date', $this->article->modified, JText::_('DATE_FORMAT_LC2'))); ?>
	</div>
<?php endif; ?>
<div class="newcontlink">

				<?php echo '<a href="'.JRoute::_(ContentHelperRoute::getSectionRoute($this->article->sectionid)).'">'; ?>

			Інші <?php echo $this->escape($this->article->section); ?>
