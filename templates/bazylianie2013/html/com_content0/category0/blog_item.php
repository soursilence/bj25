...
<div class="title">
       	      <a href="?option=com_content&amp;view=article&amp;id=<?php echo $this->item->id ?>&amp;catid=<?php echo $this->item->catid ?>&amp;Itemid=<?php echo (int)$_GET['Itemid']; ?>">
              	<?php echo $this->escape($this->item->title); ?></a>
              </div>
<?php if($tmp_data!=JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_LC2'))){ $tmp_data=JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_LC2')); ?> <div class="stamp"><span><?php  echo JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_LC2')); ?></span></div><?php } ?>
...
<?php if ($this->item->params->get('show_readmore') && $this->item->readmore) : ?>
  ...
  <div class="more">
  <div id="more_yellow">
	                       <a href="<?php echo $this->item->readmore_link; ?>"<?php //echo $this->escape($this->item->params->get('pageclass_sfx')); 
			       ?>>
